...
set shortmess=aoO
badd +0 src/curr_books/books.js
badd +0 src/curr_books/books.css
argglobal
silent! argdel *
...
exe 'vert 2resize ' . ((&columns * 79 + 105) / 210)
exe '3resize ' . ((&lines * 44 + 29) / 58)
exe 'vert 3resize ' . ((&columns * 98 + 105) / 210)
exe '4resize ' . ((&lines * 11 + 29) / 58)
exe 'vert 4resize ' . ((&columns * 178 + 105) / 210)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
terminal ++curwin ++cols=178 ++rows=11 
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
