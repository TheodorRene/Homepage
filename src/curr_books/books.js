    ...
    return (
      <div className="super_main_books">
        <h1 className="white-text center-align">
          {" "}
          <i className="fas fa-book" /> CurriculumBooks{" "}
        </h1>
        <div className={this.state.className}>
          {this.state.books && (
            <AllBooks
              books={this.state.books}
              newbook={this.handleNewBook}
              setSold={this.setSold}
            />
          )}
...
class AllBooks extends Component {
        ...
        <div key={book.bookid} className="col s12 m7">
          ...
          <div className="card horizontal">
            <div className="card-image">
              <img src="https://picsum.photos/200/300" alt="picutre" />
            </div>
            <div className="card-stacked">
              ...
              <NewBookPrice
                book={book}
                hidden={this.state.hiddenNewBookPrice}
                setSold={this.props.setSold}
              />
            </div>
            {this.isSold(book) && (
              <span className="new badge blue" data-badge-caption="Sold" />
            )}
          </div>
        </div>
      );
  ...
  render() {
    return <div className={this.state.className}>{this.listOfBooks()}</div>;
  }
}
