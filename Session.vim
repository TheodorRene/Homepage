...
nnoremap  f :setlocal foldmethod=syntax 
nnoremap  s :vs . 
nnoremap  v :split . 
nnoremap  l :! latexmk -pdf % 
nnoremap  m :! ./mdToPdf.sh % 
nnoremap  x z=1
nnoremap  a zg
nnoremap  z z=
nnoremap  c :! ./mdToPdf.sh % 
nnoremap  w :w
nmap  g :Goyo 120
xmap , <Plug>Sneak_,
omap , <Plug>Sneak_,
...
set shortmess=aoO
badd +1 src/curr_books/books.js
badd +1 src/curr_books/books.css
argglobal
silent! argdel *
$argadd src/curr_books/books.js
edit src/curr_books/books.css
...
wincmd w
argglobal
if bufexists('src/curr_books/books.js') | buffer src/curr_books/books.js | else | edit src/curr_books/books.js | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  hp <Plug>GitGutterPreviewHunk
nmap <buffer>  hu <Plug>GitGutterUndoHunk
...
wincmd w
argglobal
terminal ++curwin ++cols=210 ++rows=11 
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
